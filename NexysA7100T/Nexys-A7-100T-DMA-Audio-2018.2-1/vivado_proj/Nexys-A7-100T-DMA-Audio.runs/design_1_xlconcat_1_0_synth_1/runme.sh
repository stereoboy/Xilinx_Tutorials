...
HD_PWD='D:/Github/Jan19/Nexys-A7-100T-DMA-Audio/proj/Nexys-A7-100T-DMA-Audio.runs/design_1_xlconcat_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xlconcat_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xlconcat_1_0.tcl
